...
import { goaDepartments } from '../../data/goaDepartments';
...
const RTIByDepartmentComponent: React.FC<RTIByDepartmentProps> = ({ state: _state = 'goa' }) => {
  ...
  // Use Goa departments
  const departments = goaDepartments;
  const stateName = 'Goa';
  ...
  // Render Goa departments with multi-column text layout
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="text-center mb-3">
            <h2 className="mb-2 text-[32px] md:text-[36px] font-semibold text-gray-900">
              RTI TEMPLATES FOR {stateName.toUpperCase()} DEPARTMENTS
            </h2>
