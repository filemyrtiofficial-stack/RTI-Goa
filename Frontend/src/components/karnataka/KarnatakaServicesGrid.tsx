...
const services: Service[] = [
  {
    ...
    icon: SOFIcon,
    description: 'RTI for land records, mutation status, land conversion, revenue office records.',
    route: '/services/custom-rti',
  },
  {
    id: '2',
    name: 'Municipal Councils & Panchayats',
    icon: AnonyIcon,
    description: 'RTI for property tax, building plan approvals, trade licenses, panchayat records.',
    route: '/services/custom-rti',
  },
  {
    id: '3',
    name: 'Police Department (Goa Police)',
    icon: FirstIcon,
  ...
  },
  {
    ...
    icon: SOFIcon,
    description: 'RTI for housing board sites, layout approvals, project status, development authorities.',
    route: '/services/custom-rti',
  },
  {
    id: '8',
      ...
      <div className="container-responsive max-w-7xl mx-auto px-4">
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-[32px] sm:text-[36px] md:text-[40px] font-semibold text-gray-900 mb-4">
            Popular RTI Services in Goa
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Expert RTI drafting and filing for all Goa government departments
          </p>
        </div>
