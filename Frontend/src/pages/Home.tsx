...
export const Home: React.FC = () => {
  ...
  const pageDescription = `File RTI online in Goa with FileMyRTI. Get expert-drafted RTI applications and appeals for Goa Government departments, Secretariat and district offices from home.`;
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content={`RTI, Goa, Right to Information, File RTI Online, Goa RTI, RTI Act 2005, Goa government information, RTI filing Goa, RTI application Goa`} />
            ...
            <div className="bg-primary-600 pt-12 pb-12" data-loading>
              <div className="container-responsive max-w-7xl mx-auto px-4">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-tight">
                  File RTI Online for Goa Government Departments
                </h1>
              </div>
            </div>
          }>
            <KarnatakaHero stateName="Goa" />
          </Suspense>
