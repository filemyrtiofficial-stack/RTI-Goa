...
export const FAQPage: React.FC = () => {
  ...
  const pageTitle = "FAQ - FileMyRTI | Karnataka RTI Frequently Asked Questions";
  const pageDescription = "Find answers to common questions about RTI filing in Karnataka, our services, pricing, payment, tracking, and more. Get all the information you need to file RTI applications online for Karnataka Government departments.";
  ...
  const faqCategories = [
    ...
    { id: 'karnataka', label: 'Karnataka RTI' },
  ...
  const generalFAQs: FAQ[] = [
    ...
    {
      q: 'Can I file RTI to Goa Secretariat online?',
      a: 'Yes, you can file RTI applications to Goa Secretariat and all state departments online through FileMyRTI. We handle drafting, submission, and tracking for you without requiring you to visit government offices.'
    },
    {
      q: 'How long does RTI reply take in Goa?',
      a: 'As per RTI Act 2005, government departments in Goa must respond within 30 days. In case of information concerning the life or liberty of a person, the response must be provided within 48 hours. If the application is transferred to another authority, the response time is 35 days.'
    },
    {
      q: 'Can I file RTI for land records in Goa?',
      a: 'Yes, you can file RTI applications for land records, mutation status, and related information from Goa Revenue Department and other relevant authorities. We help you draft and file RTI applications for land-related queries.'
    },
    {
  ...
  const goaFAQs: FAQ[] = [
    ...
    {
      q: 'Can RTI get land details in Goa?',
      a: 'Yes, you can file RTI to get land records, mutation status, and revenue information from Goa Revenue Department. We help you draft and file RTI applications for land-related queries including mutations, ownership records, and property tax information.'
    },
    {
      q: 'What if I don\'t know the department?',
      a: 'No problem! Our expert team will identify the correct Goa department and Public Information Officer (PIO) based on your query. Just tell us what information you need, and we\'ll handle the rest. We maintain an extensive database of Goa departments and their PIOs.'
    },
    {
    ...
    {
      q: 'Can I file RTI for Karnataka government schemes and subsidies?',
      a: 'Yes, you can file RTI applications to get information about Karnataka government schemes, subsidy status, benefit distribution, pension details, and welfare program information. We help you draft RTI queries for various state welfare programs.'
    },
    {
      q: 'What if my RTI is rejected in Goa?',
      a: 'If your RTI application is rejected, we\'ll inform you immediately with the reason. You can then file a First Appeal with the First Appellate Authority (FAA) within 30 days. We can also assist you with filing the First Appeal and Second Appeal with Goa State Information Commission.'
    },
    {
      q: 'Which Goa departments can I file RTI to?',
      a: 'You can file RTI to all Goa State departments including Secretariat, Revenue Department, Police Department, Education, Health, Transport, Municipal Councils, Village Panchayats, Registration & Stamps, Commercial Taxes, and all district offices. We cover all Goa departments and local bodies.'
    }
  ];
          ...
          <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-12 md:py-16 lg:py-20">
            <div className="container-responsive max-w-7xl mx-auto px-4 text-center">
              ...
              <p className="text-lg sm:text-xl text-primary-100 max-w-3xl mx-auto">
                Find answers to common questions about RTI filing in Karnataka, our services, pricing, and more. Get information about Karnataka RTI rules, departments, and filing process. Can't find what you're looking for? Contact our support team.
              </p>
            </div>
          </section>
